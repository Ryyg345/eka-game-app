...
const DYNASTY_NAMES = ['Chalukya','Pallava','Rashtrakuta','Pratihara','Pala','Chola','Paramara','Chahamana','Gahadavala','Chandela','Solanki','Yadava'];
const RULER_NAMES = {
  male: ['Vikramaditya','Dhruva','Govinda','Nagabhata','Mihira','Bhoja','Jayapala','Simhavishnu','Narasimha','Somesvara'],
  female: ['Didda','Sugandha','Prabhavati','Kundavai','Sembiyan','Tribhuvana']
};
const TRAITS = [
...
const rndName = () => Math.random() > 0.15 ? pick(RULER_NAMES.male) : pick(RULER_NAMES.female);

const makeChar = (isSelf) => ({
  name: rndName(),
...
const makeFaction = (index, isPlayer = false) => {
  ...
  return {
    id: index, name: DYNASTY_NAMES[index],
    ruler: makeChar(isPlayer),
    territories: t, gold: rnd(100,300), food: rnd(150,400),
    manpower: t * rnd(500,1000), stability: rnd(40,80),
        ...
        <div style={{ ...card, background:'rgba(120,53,15,0.4)', marginBottom:'1rem' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'0.5rem' }}>
            ...
            <div style={{ textAlign:'right' }}>
              <div style={{ fontSize:'0.7rem', color:'#fbbf24' }}>LEGACY</div>
